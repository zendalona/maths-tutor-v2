...
Item {
    ...
    Component.onCompleted: {
        ...
        // Sets the question type in the Python backend (via the 'bridge' object) to "story".
        // This informs the backend that we are dealing with story-related questions.
        ...
        // obtained from the 'getfileurl' function (also in python backend).
    ...
    */
    ...
    Rectangle {
        ...
        Button {
            ...
            anchors.topMargin: 20
            onClicked: {
                completionScreen.visible = false
                root.pr_finalScore = 0
                root.pr_timeTaken = 0
                bridge.resetLevel() // Call a backend function to reset the level
            }
        }
