...
Item {
    ...
    Keys.onReturnPressed: {
        console.log("Correct answer", pr_answer.toFixed(1).toString())
        console.log("User answer", answer.text)
        if(answer.text.toString() === pr_answer.toFixed(1).toString()){
    ...
    Keys.onEnterPressed: {
        console.log("Correct answer", pr_answer.toFixed(1).toString())
        if(answer.text === pr_answer.toFixed(1).toString()){
    ...
    ApplicationWindow {
        ...
        Rectangle {
            ...
            ComboBox {
                ...
                Text {
                    id: name
                    text:difficultyComboBox.currentText
                    anchors{
                        centerIn: difficultyComboBox
                    }
                }
                textRole: "modelData"
                ...
                onCurrentIndexChanged: {
                    ...
                    console.log("Difficulty level", difficultyComboBox.currentText)
                }
            }
